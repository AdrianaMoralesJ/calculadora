...
function cbinario(){
let numero=x;
let dB=numero.toString(2);
pantalla.innerHTML=dB;
op="no"
xi=1;
}
...
function cOctagonal(){
  let numero=x;
  let dO=numero.toString(8);
  pantalla.innerHTML=dO;
  op="no";
  xi=1;
}
function cHexadecimal(){
  let numero=x;
  let dh=numero.toString(16);
  pantalla.innerHTML=dh;
  op="no";
  xi=1;
}
